...
export interface paths {
    ...
    "/api/dev/evict-bots": {
         ...
         *
         *     A bot is a Recall-side entity: killing the backend that dispatched it does not remove it from the meeting, it just orphans it there until Recall's `everyone_left_timeout` expires. After a hard restart that leaves a silent, deaf Kindred sitting in the call next to the new one.
         *
...
export interface components {
    schemas: {
         ...
         * @description Kindred was cut off — the kill phrase, or the interrupt endpoint.
         */
        SpeechInterruptedData: {
            /**
             * Cancelled Tasks
        ...
        "VoiceSettings-Input": {
            ...
            /**
             * Voice Id
             * @description Provider-specific voice id, or null to use the one the server is configured with (`INWORLD_VOICE_ID`). Null is the default because a made-up id is not a placeholder here — the provider looks it up and 404s, and Kindred goes silent mid-meeting.
             * @example Dennis
             */
